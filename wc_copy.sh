...
## Make a directory in the directory from WHERE you submitted the script $SUBMITDIR is replaced byt he location where you submit the script
mkdir -p $SUBMITDIR/result   #create a result directory
